    ...
    <section>
      <div className="md:flex gap-5">
        <div className="flex-1">
          <img data-aos="flip-up" className="rounded" src={aboutUs} alt="about-us" />
        </div>
        <div className="flex-1">
          <h1 data-aos="fade-left" className="text-primary-color font-semibold text-2xl py-5">
            About Us
          </h1>
          <h2 data-aos="fade-left" className="font-medium text-4xl pb-5">
            We Help Corporate to Manage Event
          </h2>
          <p data-aos="fade-left" className="text-lg  capitalize">
          ...
          <div data-aos="zoom-in" className="flex justify-center items-center w-full mt-5">
